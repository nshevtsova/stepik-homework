...
try: 
    # Шаг 10 - Тест проходит с:
	# Чтобы проверить шаг 10 нужно раскоментить строку 7 и закоментить строку 10
    # link = "http://suninjuly.github.io/registration1.html"
	
    # Шаг 11 - Тест не проходит с:
    ...
    input3.send_keys("ip@example.com")
